        ...
        <div class="">
            ...
            <table style="width:100%">
                <tr>
                    ...
                    <td style="width:40%; vertical-align: top">
                        <table class="table-title">
                            <tr>
                                <td class="label">{{ $fields['invoice_date'] }}</td>
                                <td class="colon">:</td>
                                <td class="content">{{ $date }}</td>
                            </tr>
                            <tr>
                                <td class="label">{{ $fields['invoice_no'] }}</td>
                                <td class="colon">:</td>
                                <td class="content">{{ $invoice_number }}</td>
                            </tr>
                            @if ($receipent_contract)
                                <tr>
                                    <td class="label">{{ $fields['contract_no'] }}</td>
                                    <td class="colon">:</td>
                ...
                <tr>
                    <td style="width:40%;vertical-align: top">
                        <table class="table-title">
                            @if ($shipping_number)
                                <tr>
                                    <td class="label">{{ $fields['si_no'] }}</td>
                                    <td class="colon">:</td>
                                    <td class="content">{{ $shipping_number }}</td>
                                </tr>
                            @endif
                            <tr>
                                <td class="label">{{ $fields['quantity'] }}</td>
                                <td class="colon">:</td>
                                <td class="content">{{ $details['cargo'] }} WMT</td>
                            </tr>
                            <tr>
                                <td class="label">{{ $fields['price'] }}</td>
                                <td class="colon">:</td>
                                <td class="content">{{ $details['hpm'] }}</td>
                            </tr>
                            <tr>
                                <td class="label">{{ $fields['rate'] }}</td>
                                <td class="colon">:</td>
                                <td class="content">{{ $details['kurs'] }}</td>
                            </tr>
                            <tr>
                                <td class="label">{{ $fields['idr_price'] }}</td>
                                <td class="colon">:</td>
                ...
                <tr>
                    <td>
                        <table class="table-details">
                            <thead>
                                <tr>
                                    <th class="tengah">{{ $fields['description'] }}</th>
                                    <th class="tengah">{{ $fields['tonage'] }} (MT)</th>
                                    <th class="tengah">{{ $fields['price'] }} ({{ $fields['rp_mt'] }})</th>
                                    <th class="tengah" style="width: 150px">{{ $fields['amount'] }}</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                @if ($termins)
                                    ...
                                    @endif
                                    <tr>
                                        <td colspan="3" class="kanan tebal nowrap">
                                            {{ $fields['total_invoice_dpp'] }}</td>
                                        <td class="kanan tebal nowrap">{{ $termins['dpp'] }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="kanan tebal nowrap">{{ $fields['dpp_nilai_lain'] }}
                                        </td>
                                        <td class="kanan tebal nowrap">{{ $termins['dpp_lain'] }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="kanan tebal nowrap">{{ $fields['ppn_dibebaskan'] }}
                                        </td>
                                        <td class="kanan tebal nowrap">{{ $termins['ppn_dibebaskan'] }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="kanan merah nowrap">{{ $fields['potongan_pph'] }}
                                        </td>
                                    ...
                                    @if ($pre_payment_type)
                                        <tr>
                                            <td colspan="3" class="kanan tebal merah nowrap">
                                                {{ $pre_payment_type }}</td>
                                            <td class="kanan tebal merah nowrap">{{ $pre_payment }}</td>
                                        </tr>
                                    @endif
                                ...
                                <tr>
                                    <td colspan="3" class="kanan tebal nowrap lebih-besar">
                                        {{ $fields['total_invoice'] }}</td>
            ...
            @if (count($receipts) > 0)
                <div class="line-space">
                    <table class="table-title">
                        <tr>
                            <td class="bill-to">{{ $fields['payment_history'] }}</td>
                            {{-- <td class="colon"></td>
                            <td class="content">
                            </td> --}}
                        </tr>
                        <tr>
                            <td>
                                <table class="table-history" style="border: 1px solid #111">
                                    <thead>
                                        <tr>
                                            <th class="tengah" style="width: 70px">{{ $fields['date'] }}</th>
                                            <th class="tengah" style="width: 160px">{{ $fields['transaction_no'] }}
                                            </th>
                                            <th class="">{{ $fields['description'] }}</th>
                    ...
                    <table class="table-title">
                        <tr>
                            <td>
                                <div class="info-bank">
                                    <div class="line-space">
                                        <div class="bill-to"><strong>{{ $fields['payment_via'] }}</strong></div>
                                        <table class="table-bank">
                                            ...
                                            <tbody>
                                                ...
                                                @else
                                                    <tr style="text-align: left">
                                                        <td class="">{{ $fields['bank_not_set'] }}</td>
                                                    </tr>
                                                @endif
                                            </tbody>
                                        </table>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td style="width:30%; vertical-align: top">
                    <table class="table-title">
                        <tr>
                            <td class="label">{{ $fields['regards'] }},</td>
                            <td class="colon"></td>
                            <td class="content"></td>
                        </tr>
                        <tr>
